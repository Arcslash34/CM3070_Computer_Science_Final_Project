...
import QuizzesHome from "../containers/QuizzesContainer";
import QuizSet from "../containers/QuizSetContainer";
import QuizGame from "../containers/QuizGameContainer";
...
import ResourceArticle from "../containers/ResourceArticleContainer";
...
import Articles from "../screens/HomeArticleScreen";
...
function TabNavigator() {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        name="Resource"
        component={ResourceHubContainer}
        options={{
...
export default function MainNavigator() {
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      {/* Results / History */}
      <Stack.Screen name="ResultSummary" component={ResultSummaryContainer} />
      <Stack.Screen
