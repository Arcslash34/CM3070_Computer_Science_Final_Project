// screens/ResultSummaryScreen.js
    ...
    <>
      <SafeAreaView edges={["top", "left", "right"]} style={styles.topSafe}>
        <View style={styles.topBar}>
          ...
          <Text style={styles.topTitle} numberOfLines={1}>{quizTitle}</Text>
      ...
      <View style={styles.heroWrap}>
        ...
        <View style={styles.kpiRow}>
          <View style={styles.kpiCard}>
            <MaterialIcons name="switch-access-shortcut-add" size={38} color="#111827" style={styles.kpiIcon} />
          ...
          <View style={styles.kpiCard}>
            <MaterialIcons name="stars" size={38} color="#111827" style={styles.kpiIcon} />
            <View style={styles.kpiTextCol}>
      ...
      <View style={[styles.card, { borderLeftColor: borderColor }]}>
        ...
        {item.status === "unanswered" && (
          <Text style={styles.unanswered}>
            {t("resultSummary.unanswered", { defaultValue: "Time’s up, No Answer Selected" })}
          </Text>
        )}

        <Text style={styles.correct}>
          {t("resultSummary.correctAnswer", { defaultValue: "Correct Answer:" })} {item.correctAnswer}
        </Text>
        <Text style={styles.answer}>
          {t("resultSummary.yourAnswer", { defaultValue: "Your Answer:" })} {item.selectedAnswer || "—"}
        </Text>
      </View>
    );
  };
...
const styles = StyleSheet.create({
  ...
  topBar: {
    ...
    borderBottomWidth: 1, borderColor: "#E5E7EB", backgroundColor: "#FFFFFF",
  },
  topBtn: { width: 36, height: 36, alignItems: "center", justifyContent: "center" },
  topTitle: { fontSize: 18, fontWeight: "800", color: "#111827", maxWidth: "70%", textAlign: "center" },
  heroWrap: { paddingHorizontal: 16, paddingTop: 14 },
  trophy: { alignSelf: "center", width: 240, height: 240, resizeMode: "contain", marginBottom: 6 },
  headline: { textAlign: "center", fontSize: 20, fontWeight: "800", color: "#111827", marginBottom: 15 },
  kpiRow: { flexDirection: "row", gap: 10, marginBottom: 12 },
  kpiCard: {
    flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center",
    backgroundColor: "#FFFFFF", borderRadius: 12, borderWidth: 1, borderColor: "#E5E7EB",
    paddingVertical: 8, paddingHorizontal: 12, shadowColor: "#000", shadowOpacity: 0.05,
  ...
  kpiValue: { color: "#111827", fontSize: 20, fontWeight: "800", textAlign: "center" },
  kpiLabel: { color: "#6B7280", fontSize: 13, textAlign: "center" },
  sectionDivider: { height: 1, backgroundColor: "#E5E7EB", marginTop: 8, marginBottom: 10 },
  sectionTitle: { fontSize: 22, fontWeight: "800", color: "#111827", marginBottom: 10, textAlign: "center" },
  card: {
    backgroundColor: "#FFFFFF", borderRadius: 10, marginBottom: 14, padding: 14,
    borderLeftWidth: 5, shadowColor: "#000", shadowOpacity: 0.06, shadowRadius: 6,
    shadowOffset: { width: 0, height: 3 }, elevation: 2, marginHorizontal: 16,
  },
