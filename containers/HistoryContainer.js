// containers/HistoryContainer.js
import React, { useCallback, useMemo, useState } from "react";
import { useFocusEffect, useNavigation } from "@react-navigation/native";
import { Alert } from "react-native";
import { supabase } from "../supabase";
import { t, i18n } from "../translations/translation";
import { getLocalizedTitle, fmtDateOnly, fmtTimeOnly } from "../utils/historyHelpers";
...
export default function HistoryContainer() {
  ...
  const vm = {
    ...
    // state
    results, filtered, query, setQuery, showSearch, setShowSearch,
