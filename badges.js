...
const RAW_BADGES = [
  ...
  // First Aid Heroes
  {
    id: "cpr-hero",
    title: "CPR Hero",
    group: "First Aid Heroes",
    earned: true,
  },
  {
    id: "bleeding-master",
    title: "Bleeding Controller",
    group: "First Aid Heroes",
    earned: true,
  },
  {
    id: "fracture-fixer",
    title: "Fracture Fixer",
    group: "First Aid Heroes",
    earned: true,
  },
];
  ...
  return (
    <View style={s.statPill}>
      ...
      <View style={s.statIconWrap}>
        <Ionicons name={icon} size={34} color="#EDE9FE" />
      </View>
...
const s = StyleSheet.create({
  ...
  statTextCol: {
    minWidth: 0, // allows text to shrink/ellipsize
    alignItems: "center", // center value + label horizontally
    justifyContent: "center", // center vertically relative to icon
  },
  statValue: { color: "#FFFFFF", fontWeight: "600", fontSize: 20 },
  statLabel: { color: "#EDE9FE", fontWeight: "600", fontSize: 13 },
